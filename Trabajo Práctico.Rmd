...
=======
#### [Trabajo Práctico Nº3](#tp_3)
>>>>>>> bc48ee111ba0f061adceb196c8e68fbf2df728cf
...
manzanas <- st_read ("https://raw.githubusercontent.com/MEU-CDPC2/TPS/main/Datasets/manzanas.geojson")
bicis <- st_read("https://raw.githubusercontent.com/MEU-CDPC2/TPS/main/Datasets/bicis.geojson")
bicis_2020 <- read_csv ("https://github.com/MEU-CDPC2/TPS/blob/main/Datasets/usuarios_ecobici_2020.csv")
```
=======
```{r}
library(lubridate)
...
```{r}
prueba <- read_csv("Dataset/usuarios_ecobici_2020.csv")
```
