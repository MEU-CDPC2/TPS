...
```{r}
bicis_2020 <- read_csv("Datasets/bicis_microcentro.csv")
```
...
Cómo vemos, la columna "duración_recorrido" ya cuenta con la información, pero expresada en segundos. Por lo tanto, sólo nos limitaremos a expresarla en minutos.
...
ggmap(mapamicrocentro) +
  ...
  labs(title="Densidad de uso de bicis en microcentro",
       subtitle="Año 2020",
       caption= "Fuente de datos: BA Data",
